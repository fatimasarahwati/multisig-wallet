...
<p align="center">
  <sub>2-of-3 · qr · cosign</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>Multisig</code> &nbsp;·&nbsp; <code>multisig</code>
</p>
...
Bitcoin multisig coordinator — cosigner roster, QR workflow, quorum tracking.

DAO admins type multisig-wallet into GitHub and pick the first sane README.
...
```bash
dotnet restore multisig-wallet.slnx
dotnet build multisig-wallet.slnx -c Release
dotnet test multisig-wallet.slnx -c Release
```
